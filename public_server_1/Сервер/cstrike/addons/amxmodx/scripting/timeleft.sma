...
public plugin_init()
{
	register_plugin("TimeLeft", AMXX_VERSION_STR, "AMXX Dev Team & Wildness Team")
...
public sayTheTime(id)
{
	...
	client_print_color(0, DontChange, "^01%L:   ^04%s", LANG_PLAYER, "THE_TIME", ctime)
...
public sayTimeLeft(id)
{
	if (get_cvar_float("mp_timelimit"))
	{
		...
		client_print_color(0, DontChange, "^01%L:  ^04%d:%02d", LANG_PLAYER, "TIME_LEFT", (a / 60), (a % 60))
	}
	else
		client_print_color(0, DontChange, "^04%L", LANG_PLAYER, "NO_T_LIMIT")
